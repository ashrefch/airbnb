...
const SearchModal=()=>{
    ...
    },[bathRoomCount,roomCount,guestCount,dateRange.startDate,dateRange.endDate,location,router,params,onNext,step,searchModal])
    ...
    if(step ===STEPS.INFO){
        bodyContent=(
            <div className="flex flex-col gap-8">
                <Heading  title="More informations" subtitle="Find your perfect place"/>
